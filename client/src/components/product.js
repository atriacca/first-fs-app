let product = [
    {
        ...
        _id: "caftp-t0001",
        description: "In my opinion these are the best most durable high impact fire Nunchaku on the market. Solid wood core energetically charged with gene keys and Mayan astrology. 12 inch copper tubing outer shell with high impact ball bearing swivels and chain. Each side has 1.5 feet of 4 inch wide 1/8 inch thick K1 Kevlar with sewn wicks 3 feet of Kevlar total. Warning these have huge flames and must be kept in motion or pointing wicks straight up in the air when stopped otherwise you will get burned so dip lightly the first few times until you get the feel for them.. Check out the URL below to see them in action.",
        price: 125,
        inStock: true,
